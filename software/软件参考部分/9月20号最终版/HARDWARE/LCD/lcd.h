...
void lcd_huaxian(u16 x1,u16 y1,u16 x2,u16 y2);								//画线
void lcd_huadian(u16 a,u16 b,u16 color)	;									//画点
void LCD_Show_Chinese(u16 x,u16 y,u8 index,u16 color);						//显示中文
void LCD_Draw_Point(u16 x,u16 y,u16 color);									//画点带颜色的
void LCD_ShowContent(u16 x,u16 y,u16 color,u16 t,u16 num);					//连续显示中文函数
void LCD_ShowContent_up_down(u16 x,u16 y,u16 color);						//一直连续显示中文函数
void OLED_Showdecimal(u8 x,u8 y,float num,u8 len,u8 size2);		`			//显示小数点
